  ...
  <div class="card">
    <div class="card-body">
      ...
      <form>
        <div class="row">
          <div class="col-6">
            <table width="100%" class="table table-sm" style="font-size: 12px;">
              ...
              <tr>
                <td width="30%"><b>Karyawan</b></td>
                <td width="1%">:</td>
                <td>
                  <select style="width: 100%;" name="nik_karyawan" style="font-size: 11px;" required>
                    ...
                    ?>
                      <option value="<?php echo $get_karyawan['nik']; ?>" <?php if($get_evaluasi['nik'] == $get_karyawan['nik']){ echo "selected"; } ?>><?php echo $get_karyawan['nama']; ?></option>
                    <?php } ?>
                  </select>
                </td>
              </tr>
              <tr>
                ...
                <td width="1%">:</td>
                <td width="">
                  <select style="width: 100%;" name="jabatan" style="font-size: 11px;" required>
                    <option value="" disabled>---- Pilih Jabatan ----</option>
                    <option value="Magang" <?php if($get_evaluasi['jabatan'] == "Magang"){ echo "selected"; } ?>>Magang</option>
                    <option value="Kontrak" <?php if($get_evaluasi['jabatan'] == "Kontrak"){ echo "selected"; } ?>>Kontrak</option>
                    <option value="Staff" <?php if($get_evaluasi['jabatan'] == "Staff"){ echo "selected"; } ?>>Staff</option>
                    <option value="Fungsional" <?php if($get_evaluasi['jabatan'] == "Fungsional"){ echo "selected"; } ?>>Fungsional</option>
                    <option value="Manager" <?php if($get_evaluasi['jabatan'] == "Manager"){ echo "selected"; } ?>>Manager</option>
                  </select>
                </td>
              </tr>
            </table>
          ...
          <div class="col-6">
            <table width="100%" class="table table-sm" style="font-size: 12px;">
              <tr>
                ...
                <td width="1%">:</td>
                <td width=""><input type="date" style="width: 100%" name="tanggal_evaluasi" value="<?php echo $get_evaluasi['tanggal_evaluasi']; ?>"></td>
              </tr>
              <tr>
                <td width="40%"><b>Periode Penilaian</b></td>
                <td width="1%">:</td>
                <td width="">
                  <select style="width: 100%;" name="semester" style="font-size: 11px;" required>
                    <option value="" disabled>Pilih Periode Penilaian</option>
                    <option value="3 Bulan (Training)" <?php if($get_evaluasi['semester'] == "3 Bulan (Training)"){ echo "selected"; } ?>>3 Bulan (Training)</option>
                    <option value="6 bulan (Training) + Semester 1" <?php if($get_evaluasi['semester'] == "6 bulan (Training) + Semester 1"){ echo "selected"; } ?>>6 bulan (Training)</option>
                    <option value="2" <?php if($get_evaluasi['semester'] == "2"){ echo "selected"; } ?>>Semester 2 (1 Tahun)</option>
                    <option value="3" <?php if($get_evaluasi['semester'] == "3"){ echo "selected"; } ?>>Semester 3 (1 Tahun 6 bulan)</option>
                    <option value="4" <?php if($get_evaluasi['semester'] == "4"){ echo "selected"; } ?>>Semester 4 (2 Tahun)</option>
                    <option value="5" <?php if($get_evaluasi['semester'] == "5"){ echo "selected"; } ?>>Semester 5 (2 Tahun 6 bulan)</option>
                    <option value="6" <?php if($get_evaluasi['semester'] == "6"){ echo "selected"; } ?>>Semester 6 (3 Tahun)</option>
                    <option value="7" <?php if($get_evaluasi['semester'] == "7"){ echo "selected"; } ?>>Semester 7 (3 Tahun 6 bulan)</option>
                    <option value="8" <?php if($get_evaluasi['semester'] == "8"){ echo "selected"; } ?>>Semester 8 (4 Tahun)</option>
                    <option value="9" <?php if($get_evaluasi['semester'] == "9"){ echo "selected"; } ?>>Semester 9 (4 Tahun 6 bulan)</option>
                    <option value="10" <?php if($get_evaluasi['semester'] == "10"){ echo "selected"; } ?>>Semester 10 (5 Tahun)</option>
                    <option value="11" <?php if($get_evaluasi['semester'] == "11"){ echo "selected"; } ?>>Semester 11 (5 Tahun 6 bulan)</option>
                    <option value="12" <?php if($get_evaluasi['semester'] == "12"){ echo "selected"; } ?>>Semester 12 (6 Tahun)</option>
                    <option value="13" <?php if($get_evaluasi['semester'] == "13"){ echo "selected"; } ?>>Semester 13 (6 Tahun 6 bulan)</option>
                    <option value="14" <?php if($get_evaluasi['semester'] == "14"){ echo "selected"; } ?>>Semester 14 (7 Tahun)</option>
                    <option value="15" <?php if($get_evaluasi['semester'] == "15"){ echo "selected"; } ?>>Semester 15 (7 Tahun 6 bulan)</option>
                    <option value="16" <?php if($get_evaluasi['semester'] == "16"){ echo "selected"; } ?>>Semester 16 (8 Tahun)</option>
                    <option value="17" <?php if($get_evaluasi['semester'] == "17"){ echo "selected"; } ?>>Semester 17 (8 Tahun 6 bulan)</option>
                    <option value="18" <?php if($get_evaluasi['semester'] == "18"){ echo "selected"; } ?>>Semester 18 (9 Tahun)</option>
                    <option value="19" <?php if($get_evaluasi['semester'] == "19"){ echo "selected"; } ?>>Semester 19 (9 Tahun 6 bulan)</option>
                    <option value="20" <?php if($get_evaluasi['semester'] == "20"){ echo "selected"; } ?>>Semester 20 (10 Tahun)</option>
                    <option value="21" <?php if($get_evaluasi['semester'] == "21"){ echo "selected"; } ?>>Semester 21 (10 Tahun 6 bulan)</option>
                    <option value="22" <?php if($get_evaluasi['semester'] == "22"){ echo "selected"; } ?>>Semester 22 (11 Tahun)</option>
                    <option value="23" <?php if($get_evaluasi['semester'] == "23"){ echo "selected"; } ?>>Semester 23 (11 Tahun 6 bulan)</option>
                    <option value="24" <?php if($get_evaluasi['semester'] == "24"){ echo "selected"; } ?>>Semester 24 (12 Tahun)</option>
                    <option value="25" <?php if($get_evaluasi['semester'] == "25"){ echo "selected"; } ?>>Semester 25 (12 Tahun 6 bulan)</option>
                    <option value="26" <?php if($get_evaluasi['semester'] == "26"){ echo "selected"; } ?>>Semester 26 (13 Tahun)</option>
                    <option value="27" <?php if($get_evaluasi['semester'] == "27"){ echo "selected"; } ?>>Semester 27 (13 Tahun 6 bulan)</option>
                    <option value="28" <?php if($get_evaluasi['semester'] == "28"){ echo "selected"; } ?>>Semester 28 (14 Tahun)</option>
                    <option value="29" <?php if($get_evaluasi['semester'] == "29"){ echo "selected"; } ?>>Semester 29 (14 Tahun 6 bulan)</option>
                    <option value="30" <?php if($get_evaluasi['semester'] == "30"){ echo "selected"; } ?>>Semester 30 (15 Tahun)</option>
                  </select>
                </td>
              </tr>
              <tr>
                <td colspan="3"><div style="font-size: 8px; color: red;"><i>*Note : Jika mengubah jabatan maka nilai akan direset menjadi 0</i></div></td>
              </tr>
            </table>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col">
            <input type="hidden" name="jabatan_old" value="<?php echo $get_evaluasi['jabatan']; ?>">
            <input type="hidden" name="no_fppk" value="<?php echo $nomor_fppk; ?>">
            <center><input type="submit" class="btn btn-success" name="edit_evaluasi_info" value="Ubah"></center>
          </div>
        </div>
      </form>
      ...
      <form method="POST" action="../<?php echo $_SESSION['role']; ?>/index.php?pages=dbevaluasi">
      <div class="row">
        <table class="table table-sm table-striped" style="font-size: 12px;">
          <thead>
            <tr align="center">
              ...
              <th width="10%">Dirut</th>
              <th width="10%">Dirop</th>
              <th width="10%">Manager/ Leader</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point1_dirut" max="1" value="<?php echo $get_evaluasi['point1_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point1_dirop" max="1" value="<?php echo $get_evaluasi['point1_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point2_dirut" max="1" value="<?php echo $get_evaluasi['point2_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point2_dirop" max="1" value="<?php echo $get_evaluasi['point2_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point3_dirut" max="2" value="<?php echo $get_evaluasi['point3_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point3_dirop" max="2" value="<?php echo $get_evaluasi['point3_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td>Loyalitas</td>
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point4_dirut" max="1" value="<?php echo $get_evaluasi['point4_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point4_dirop" max="1" value="<?php echo $get_evaluasi['point4_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point5_dirut" max="1" value="<?php echo $get_evaluasi['point5_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point5_dirop" max="1" value="<?php echo $get_evaluasi['point5_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td>Kepemimpinan</td>
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point6_dirut" max="1" value="<?php echo $get_evaluasi['point6_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point6_dirop" max="1" value="<?php echo $get_evaluasi['point6_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">2</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point7_dirut" max="2" value="<?php echo $get_evaluasi['point7_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point7_dirop" max="2" value="<?php echo $get_evaluasi['point7_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point8_dirut" max="1" value="<?php echo $get_evaluasi['point8_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point8_dirop" max="1" value="<?php echo $get_evaluasi['point8_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point9_dirut" max="1" value="<?php echo $get_evaluasi['point9_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point9_dirop" max="1" value="<?php echo $get_evaluasi['point9_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point10_dirut" max="1" value="<?php echo $get_evaluasi['point10_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point10_dirop" max="1" value="<?php echo $get_evaluasi['point10_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">2</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point11_dirut" max="2" value="<?php echo $get_evaluasi['point11_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point11_dirop" max="2" value="<?php echo $get_evaluasi['point11_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point12_dirut" max="1" value="<?php echo $get_evaluasi['point12_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point12_dirop" max="1" value="<?php echo $get_evaluasi['point12_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point13_dirut" max="1" value="<?php echo $get_evaluasi['point13_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point13_dirop" max="1" value="<?php echo $get_evaluasi['point13_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td>Tangung jawab</td>
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point14_dirut" max="1" value="<?php echo $get_evaluasi['point14_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point14_dirop" max="1" value="<?php echo $get_evaluasi['point14_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">2</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point15_dirut" max="2" value="<?php echo $get_evaluasi['point15_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point15_dirop" max="2" value="<?php echo $get_evaluasi['point15_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td align="center">1</td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point16_dirut" max="1" value="<?php echo $get_evaluasi['point16_dirut']; ?>" required></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point16_dirop" max="1" value="<?php echo $get_evaluasi['point16_dirop']; ?>" required></td>
              <td align="center">-</td>
            ...
            <tr>
              ...
              <td></td>
              <td></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point_grooming" max="2" value="<?php echo $get_evaluasi['point_grooming']; ?>" required></td>
            </tr>
            <tr>
              <td></td>
              <td>Kedisiplinan</td>
              ...
              <td></td>
              <td></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point_kedisiplinan" max="3" value="<?php echo $get_evaluasi['point_kedisiplinan']; ?>" required></td>
            </tr>
            <tr>
              <td><b>6.</b></td>
            ...
            <tr>
              ...
              <td></td>
              <td></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point_kehadiran" max="5" value="<?php echo $get_evaluasi['point_kehadiran']; ?>" required></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td></td>
              <td></td>
              <td><input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point_owoj" max="5" value="<?php echo $get_evaluasi['point_owoj']; ?>" required></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="row">
        <div class="col-12">
            <center>
              <input type="hidden" name="no_fppk" value="<?php echo $nomor_fppk; ?>">
              <input type="submit" class="btn btn-success" name="edit_evaluasi_manager" value="Simpan">
            </center>
        </div>        
      </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point1_leader" max="1" value="<?php echo $get_evaluasi['point1_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point1,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point2_leader" max="1" value="<?php echo $get_evaluasi['point2_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point2,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point3_leader" max="1" value="<?php echo $get_evaluasi['point3_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point3,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point4_leader" max="1" value="<?php echo $get_evaluasi['point4_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point4,2); ?></td>
            </tr>
            ...
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point5_leader" max="1" value="<?php echo $get_evaluasi['point5_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point5,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point6_leader" max="1" value="<?php echo $get_evaluasi['point6_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point6,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point7_leader" max="1" value="<?php echo $get_evaluasi['point7_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point7,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point8_leader" max="1" value="<?php echo $get_evaluasi['point8_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point8,2); ?></td>
            </tr>
            ...
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point13_leader" max="1" value="<?php echo $get_evaluasi['point13_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point13,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point14_leader" max="1" value="<?php echo $get_evaluasi['point14_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point14,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point15_leader" max="1" value="<?php echo $get_evaluasi['point15_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point15,2); ?></td>
            </tr>
            <tr>
              ...
              <td align="center">
                ...
                ?>
                    <input style="font-size: 11px; width: 50px" type="number" step="0.01" name="point16_leader" max="1" value="<?php echo $get_evaluasi['point16_leader']; ?>" required>
                <?php } ?>
              </td>
              <td align="center"><?php echo number_format($avg_point16,2); ?></td>
            </tr>
      ...
      <div class="row">
        <div class="col-12">
            <center>
              <input type="hidden" name="no_fppk" value="<?php echo $nomor_fppk; ?>">
              <input type="submit" class="btn btn-success" name="edit_evaluasi_fungsional" value="Simpan">
            </center>
        </div>        
      </div>
      ...
      <div class="row">
        <div class="col-12">
            <center>
              <input type="hidden" name="no_fppk" value="<?php echo $nomor_fppk; ?>">
              <input type="submit" class="btn btn-success" name="edit_evaluasi_staff" value="Simpan">
            </center>
        </div>        
      </div>
    </form>
