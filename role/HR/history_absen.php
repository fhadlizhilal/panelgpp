              ...
              <form action="index.php?pages=history_absen" method="GET" enctype="multipart/form-data">
                <div class="inner">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <center>
                        <input type="hidden" name="pages" value="history_absen">
                        <input type="submit" class="btn btn-info btn-md" name="report_absen_karyawan" value="Get Report">
                      </center>
                    </div>                  
                  </div>
                </div>
                ...
                <div class="inner">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <center>
                        <input type="hidden" name="pages" value="history_absen">
                        <input type="submit" class="btn btn-info btn-md" name="report_absen_tanggal" value="Get Report">
                      </center>
                    </div>                  
                  </div>
                </div>
              ...
              <div class="card-body">
                <?php
                  if(isset($_GET['report_absen_tanggal'])){
                    if($_GET['report_absen_tanggal'] == "Get Report"){
                ?>
                ...
                <?php
                    ...
                    if($_GET['report_absen_karyawan'] == "Get Report"){
                ?>
                  <table id="formabsen1" class="table table-bordered table-sm table-striped" width="100%" style="font-size: 12px;">
                    <thead>
                    <tr style="text-align: center;">
                    ...
                    <tbody>
                      <?php
                        $q_getAbsen = mysqli_query($conn, "SELECT * FROM absen_masuk WHERE nik = '$_GET[karyawan]' AND tanggal BETWEEN '$_GET[dari_tanggal]' AND '$_GET[sampai_tanggal]' ORDER BY tanggal ASC");
                ...
                <?php 
                    ...
                    echo "<center>Silahkan pilih <b>Get Report</b> terlebih dahulu</center?";
                  } 
                ?>
              </div>
              <!-- /.card-body -->
