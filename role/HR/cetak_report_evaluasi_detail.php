...
<head>
  ...
  <title>Panel GPP | Report Penilaian Detail Prestasi Kerja Karyawan | <?php echo $nomor_fppk;?></title>
        ...
        <table class="table table-sm table-striped" style="font-size: 12px;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center"><?php echo $get_evaluasi['point9_leader']; ?></td>
            ...
            <tr>
              ...
              <td align="center"><?php echo $get_evaluasi['point10_leader']; ?></td>
            ...
            <tr>
              ...
              <td align="center"><?php echo $get_evaluasi['point11_leader']; ?></td>
            ...
            <tr>
              ...
              <td align="center"><?php echo $get_evaluasi['point12_leader']; ?></td>
        ...
        <div class="col-6">
          ...
          <table width="100%" class="table table-sm table-bordered" style="font-size: 11px;">
            <tr style="text-align: center;">
              <td style="font-size: 25px; font-weight: bold; height: 75px; vertical-align: middle;">
                <?php 
                  echo $nilai_akhir = number_format((($nilai_point1+$nilai_point2+$nilai_point3+$nilai_point4+$nilai_point5+$nilai_point6)/5)+($nilai_point7/10),2); 
                ?>
              </td>
            </tr>
            <tr style="text-align: center;">
        ...
        <div class="col-6">
          ...
          <table width="100%" class="table table-sm table-bordered" style="font-size: 11px;">
            <tr style="text-align: center;">
              <td style="font-size: 25px; font-weight: bold; height: 75px; vertical-align: middle;">
                <?php 
                  echo $nilai_akhir = number_format((($nilai_point1+$nilai_point2+$nilai_point3+$nilai_point4+$nilai_point5+$nilai_point6)/4)+($nilai_point7/10),2); 
                ?>
              </td>
            </tr>
            <tr style="text-align: center;">
