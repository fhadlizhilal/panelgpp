    ...
    <form method="POST" action="../<?php echo $_SESSION['role']; ?>/index.php?pages=form_absen_masuk">
      <div class="card-body">
        ...
        <div class="form-group">
          <label style="font-size: 12px;">Jam Masuk</label>
          <input type="time" class="form-control" name="jam_masuk" value="<?php echo $getAbsenTmp['jam']; ?>">
          <br>
          <input type="hidden" name="id" value="<?php echo $id; ?>">
          <center><input type="submit" class="btn btn-info" name="edit_jam_absen_masuk" value="Ubah"></center>
        </div>
      </div>
    </form>
  </div>
