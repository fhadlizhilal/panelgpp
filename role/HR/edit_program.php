      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <select name="program" class="form-control" style="font-size: 12px;">
            <?php if($get_penilaianTmp['program'] == "-"){ ?>
              <option value="-">-</option>
            <?php }else{ ?>
              <option value="Ya">Ya</option>
              <option value="Tidak" <?php if($get_penilaianTmp['program'] == "Tidak"){ echo "selected" ;} ?>>Tidak</option>
            <?php } ?>
          </select>
          <br>
          <input type="hidden" name="id" value="<?php echo $id; ?>">
          <center><input type="submit" class="btn btn-info" name="edit_program" value="Ubah"></center>
        </div>
      </div>
    </form>
  </div>
