<?php
  ...
  if(isset($_POST['getID'])){
    ...
    $get_toolsMasuk = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM tools_masuk_detail_tmp WHERE id = '$id'"));
  ...
  <div class="card">
    <form method="POST" action="../<?php echo $_SESSION['role']; ?>/index.php?pages=add-masuk-tools">
      ...
      <div class="card-footer">
        ...
        <input type="submit" class="btn btn-danger" name="delete_toolsMasukDetail" value="Delete">
      </div>
    </form>
  </div>
    <!-- /.card-body -->
