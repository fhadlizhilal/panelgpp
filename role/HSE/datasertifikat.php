<!-- Content Wrapper. Contains page content -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title float-sm-right" style="font-size: 12px;">
                  <a href="#modal" data-toggle='modal' data-target='#show_add_sertifikat' data-id='<?php echo $get_forecast['kd_forecast']; ?>' data-toggle="tooltip" data-placement="bottom" title="Tambah Sertifikat">
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="font-size: 14px;">
                          <a href="#modal" data-toggle='modal' data-target='#show_edit_hsesertifikat' data-id='<?php echo $get_sertifikat['id']; ?>' data-toggle="tooltip" data-placement="bottom" title="Edit"><span class="fa fa-edit"></span></a> | 
                          <a href="#modal" data-toggle='modal' data-target='#show_delete_hsesertifikat' data-id='<?php echo $get_sertifikat['id']; ?>' data-toggle="tooltip" data-placement="bottom" title="Delete"><span class="fa fa-close"></span></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
  ...
  <!-- Modal start here -->
  <div class="modal fade" id="show_add_sertifikat" role="dialog">
