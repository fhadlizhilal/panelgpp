  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Peminjaman Belum Kembali</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="setHariLibur1" class="table table-bordered table-striped table-sm" style="font-size: 12px;">
                  ...
                  <tbody>
                    <?php
                      $no=1;
                      $q_get_project = mysqli_query($conn, "SELECT * FROM project WHERE kd_project IN (SELECT kd_project FROM asset_peminjaman) AND kd_project NOT IN (SELECT kd_project FROM asset_pengembalian_selesai WHERE kd_project IS NOT NULL)");
                    ...
                    ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td>
                          <a href="#modal" data-toggle='modal' data-target='#show_detail_pengembalian' data-id='<?php echo $get_project['kd_project']; ?>' data-toggle="tooltip" data-placement="bottom" title="Tambah Data Entitas">
