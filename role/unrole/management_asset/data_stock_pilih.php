            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  ?>
                      <div class="col-6">
                        <a href="index.php?pages=datastock&entitas=<?php echo $get_entitas['id']; ?>">
                          <div class="info-box mb-3 bg-info">
                            <span class="info-box-icon"><i class="fa fa-cube"></i></span>
                            <div class="info-box-content">
                              <div style="font-weight: bold;">DATA STOCK <?php echo strtoupper($get_entitas['entitas']); ?></div>
                            </div>
                          </div>
                        </a>
                      </div>
