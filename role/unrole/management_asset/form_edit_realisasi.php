<?php
  ...
  if(isset($_POST['simpan_form_realisasi'])){
    if($_POST['simpan_form_realisasi'] == "simpan"){
      ...
      //Update realisasi
      mysqli_query($conn, "UPDATE asset_pengajuan SET tgl_realisasi = '$_POST[tgl_realisasi]' WHERE id = '$_POST[pengajuan_id]'");
      echo "<meta http-equiv='refresh' content='0;url=index.php?pages=pengajuancompleted'>";
      $_SESSION['alert_info'] = "Form Realisasi Berhasil Disimpan!<br>Tunggu sampai halaman diarahkan ke halaman selanjutnya";
    }
  }
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Form Edit Realisasi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  ...
                  <table class="table table-sm" style="font-size: 11px; margin-bottom: 15px;">
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td><input type="date" width="100px" name="tgl_realisasi" value="<?php echo $get_pengajuan['tgl_realisasi']; ?>"></td>
                    </tr>
                    <tr>
                      <td>Project</td>
                      <td>:</td>
