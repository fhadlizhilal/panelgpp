              ...
              <div class="card-body">
                <table id="setHariLibur1" class="table table-bordered table-striped table-sm" style="font-size: 11px;">
                  ...
                  <tbody>
                    <?php
                      $no = 1;
                      $q_get_pengembalian = mysqli_query($conn,"SELECT * FROM asset_pengembalian WHERE penanggungjawab = '$_SESSION[nik]' AND status = 'BA approved'");
                    ...
                    ?>
                      <tr>
                        ...
                        <td><span class="badge badge-success"><?php echo $get_pengembalian['status']; ?></span></td>
                      </tr>
                    <?php $no++; } ?>
                  </tbody>
                </table>
