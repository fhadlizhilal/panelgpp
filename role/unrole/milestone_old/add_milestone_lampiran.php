<?php
  ...
  if(isset($_POST['add_attachment_images'])){
    if($_POST['add_attachment_images'] == "Submit"){
      if($_FILES["file"]["name"] != ""){
        ...
        if(!empty($_FILES["file"]["name"])) { 
            ...
            if(in_array($fileType, $allowTypes)){ 
                ...
                if($compressedImage){
                  $push_lampiran_images = mysqli_query($conn, "INSERT INTO milestone_list_lampiranimg VALUES('','$_POST[milestone_id]','$fileName')");
  ...
  if(isset($_POST['delete_lampiran_images'])){
    if($_POST['delete_lampiran_images'] == "delete"){
      $delete_lampiran_images = mysqli_query($conn, "DELETE FROM milestone_list_lampiranimg WHERE id = '$_POST[id]'");
      if($delete_lampiran_images){
        unlink("../unrole/milestone/lampiran_images/".$_POST['nama_img']);
      }
    }
  }

  if(isset($_POST['add_attachment_file'])){
    if($_POST['add_attachment_file'] == "Submit"){
      ...
      if ($uploadOk == 1) {
          if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
              $push_lampiran_file = mysqli_query($conn, "INSERT INTO milestone_list_lampiranfile VALUES('','$_POST[milestone_id]','$fileName')");
  ...
  if(isset($_POST['delete_lampiran_file'])){
    if($_POST['delete_lampiran_file'] == "delete"){
      $delete_lampiran_file = mysqli_query($conn, "DELETE FROM milestone_list_lampiranfile WHERE id = '$_POST[id]'");
      if($delete_lampiran_file){
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Form Add Milestone Attachment</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <table class="table table-sm" style="font-size: 12px">
                  <tr>
                    ...
                    <td width="1%">:</td>
                    <td><?php echo $get_milestoneList['job_description']; ?></td>
                  </tr>
                  <tr>
                    <td>Person</td>
                    <td width="1%">:</td>
                  ...
                  <tr>
                    <td>Due Date</td>
                    <td width="1%">:</td>
                    <td><?php echo date("d F Y", strtotime($get_milestoneList['due_date'])); ?></td>
                  </tr>
                </table>
                <br>

                <div style="font-size: 12px; margin-bottom: 5px;">
                  <a href="#modal" data-toggle='modal' data-target='#show_add_attachmentimg' data-id='<?php echo $get_milestoneList['id']; ?>' data-toggle="tooltip" data-placement="bottom" title="Add Attachment Images">
                ...
                <div class="card-body p-0">
                  <div class="row">
                    <?php
                      $no=11;
                      $q_get_lampiran_images = mysqli_query($conn, "SELECT * FROM milestone_list_lampiranimg WHERE milestone_list_id = '$_GET[id]'");
                        ...
                        <div class="col-lg-4 col-2" style="margin-bottom: 10px;">
                          <img src="../unrole/milestone/lampiran_images/<?php echo $get_lampiran_images["nama_img"]; ?>" alt="..." style="width: 100%">
                            ...
                            <form id="myForm<?php echo $no; ?>" method="POST" action="" style="text-align: center;">
                              ...
                              <button type="submit" class="btn btn-danger btn-xs" name="delete_lampiran_images" value="delete" onclick="return confirm('Yakin delete gambar ini?')">
                ...
                <div style="font-size: 12px;">
                  <a href="#modal" data-toggle='modal' data-target='#show_add_attachmentfile' data-id='<?php echo $get_milestoneList['id']; ?>' data-toggle="tooltip" data-placement="bottom" title="Add Attachment File">
                ...
                <div class="card-body p-0">
                  <table class="table table-sm" style="font-size: 12px;">
                    ...
                    <tbody>
                      <?php
                        $no=1;
                        $q_get_lampiran_file = mysqli_query($conn, "SELECT * FROM milestone_list_lampiranfile WHERE milestone_list_id = '$_GET[id]'");
                        ...
                        <tr>
                          ...
                          <td style="font-size: 14px;">
                            <form id="myForm<?php echo $no; ?>" method="POST" action="" enctype="multipart/form-data">
                              ...
                              <button type="submit" class="btn btn-danger btn-xs" name="delete_lampiran_file" value="delete" onclick="return confirm('Yakin delete file ini?')">
                ...
                <form method="POST" action="">
                  <hr>
                  <center>
                    <a href="index.php?pages=milestone_list&show=open"><div class="btn btn-success">Save Attachment</div></a>
                  </center>
                </form>
              </div>
              <!-- /.card-body -->
  ...
  <!-- Modal start here -->
  <div class="modal fade" id="show_add_attachmentimg" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Add Attachment Images</h4>
        ...
        <div class="modal-body">
          <form id="myForm" method="POST" action="" enctype="multipart/form-data">
            ...
            <input type="submit" class="btn btn-success" name="add_attachment_images" value="Submit">
          </form>
        </div>
      </div>
      <!-- /.modal-content -->
  ...
  <!-- Modal start here -->
  <div class="modal fade" id="show_add_attachmentfile" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form id="myFormA" method="POST" action="" enctype="multipart/form-data">
            ...
            <br>
            <input type="hidden" name="milestone_id" value="<?php echo $_GET['id']; ?>">
            <input type="submit" class="btn btn-success" name="add_attachment_file" value="Submit">
          </form>
        </div>
      </div>
      <!-- /.modal-content -->
