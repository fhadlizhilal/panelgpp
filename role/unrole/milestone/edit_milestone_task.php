      ...
      if($_FILES["file"]["name"] != ""){
        ...
        if(!empty($_FILES["file"]["name"])) { 
            ...
            if(in_array($fileType, $allowTypes)){ 
                ...
                if($compressedImage){
                  $push_lampiran_images = mysqli_query($conn, "INSERT INTO milestone_list_lampiranimg VALUES('','$_POST[milestone_detail_id]','$fileName')");
    ...
    if($_POST['add_attachment_file'] == "Submit"){
      ...
      if ($uploadOk == 1) {
          if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
              $push_lampiran_file = mysqli_query($conn, "INSERT INTO milestone_list_lampiranfile VALUES('','$_POST[milestone_detail_id]','$fileName')");
          ...
          $_SESSION['alert_error'] = "File tidak diunggah.".$fileName;
      }
    }
  }
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div style="font-size: 12px; margin-bottom: 5px;">
                  <a href="#modal" data-toggle='modal' data-target='#show_add_attachmentimg' data-id='<?php echo $get_milestone_detail['id']; ?>' data-toggle="tooltip" data-placement="bottom" title="Add Attachment Images">
                ...
                <div style="font-size: 12px;">
                  <a href="#modal" data-toggle='modal' data-target='#show_add_attachmentfile' data-id='<?php echo $get_milestone_detail['id']; ?>' data-toggle="tooltip" data-placement="bottom" title="Add Attachment File">
                ...
                <form method="POST" action="index.php?pages=milestonelist&show=open">
                  <table class="table table-sm" style="font-size: 12px">
                    <tr>
                      ...
                      <td width="1%">:</td>
                      <td>
                        <input type="text" class="form-control form-control-sm" name="job_description" value="<?php echo $get_milestone_detail['job_description']; ?>" required>
                      </td>
                    </tr>
                    <tr>
                      <td>Due Date</td>
                      <td width="1%">:</td>
                      <td>
                        <input type="datetime-local" class="form-control form-control-sm" name="due_date" value="<?php echo $get_milestone_detail['due_date']; ?>">
                      </td>
                    </tr>
                    <tr>
                      <td>Person</td>
                  ...
                  <center>
                    ...
                    <button type="submit" class="btn btn-success" name="simpan_milestone_task" value="Simpan">Save Task</button>
                  </center>
                </form>
              </div>
              <!-- /.card-body -->
