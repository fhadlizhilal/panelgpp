<?php
  ...
  $get_submission = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM submission_list WHERE milestone_detail_id = '$_GET[id]'"));
                ...
                <form method="POST" action="index.php?pages=milestonelist&show=open">
                  <div class="form-group row" style="margin-bottom: 8px;">
                    <div class="col-sm-12">
                      ...
                      <textarea class="form-control form-control-sm" name="comments" required><?php echo $get_submission['comments']; ?></textarea>
                    </div>
                  </div>
                  <center>
