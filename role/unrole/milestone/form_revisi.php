<?php
  ...
  $get_submission = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM submission_list WHERE id = '$_GET[subid]'"));
              ...
              <div class="card-body">
                <table class="table table-sm" style="font-size: 12px">
                  <tr>
                    ...
                    <td width="1%">:</td>
                    <td><?php echo $get_submission['comments']; ?></td>
                  </tr>
                  <tr>
                    <td>Person</td>
                    <td width="1%">:</td>
                  ...
                  <tr>
                    <td>Submitted at</td>
                    <td width="1%">:</td>
                    <td><?php echo date("d F Y H:i", strtotime($get_submission['submitted_at'])); ?></td>
                  </tr>
                </table>
                <br>
                ...
                <div class="card-body p-0">
                  <div class="row">
                    <?php
                      $q_get_lampiran_images = mysqli_query($conn, "SELECT * FROM submission_list_lampiranimg WHERE milestone_detail_id = '$get_submission[milestone_detail_id]'");
                ...
                <div class="card-body p-0">
                  <table class="table table-sm" style="font-size: 12px;">
                    ...
                    <tbody>
                      <?php
                        $no=1;
                        $q_get_lampiran_file = mysqli_query($conn, "SELECT * FROM submission_list_lampiranfile WHERE milestone_detail_id = '$get_submission[milestone_detail_id]'");
...
<!-- --------------------------------------------------- My Cooments / Revision ------------------------------ -->

          <div class="col-lg-6 col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="font-size: 14px; font-weight: bold;">
                  My Comments / Revision
                </h3>
              </div>
              <div class="card-body">
                ...
                <br>
                <form id="myFormB" method="POST" action="index.php?pages=milestonelist&show=open">
                  <div class="form-group row" style="margin-bottom: 8px;">
                    <div class="col-sm-12">
                      <label style="font-size: 12px;">Comments</label>
                      <textarea class="form-control form-control-sm" name="comments" required><?php echo $get_milestone_detail['job_description']; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group row" style="margin-bottom: 8px;">
                    <div class="col-sm-8">
                  ...
                  <center>
                    ...
                    <input type="submit" class="btn btn-success btn-flat" name="submit_milestone_revisi" value="Submit Comments">
                  </center>
                </form>
