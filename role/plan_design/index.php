<?php
  ...
  if(!isset($_SESSION["role"]) || $_SESSION["role"] != "plan_design"){
...
//------ Upload File Approval -----------------------------
  if(isset($_POST['upload_file'])){
    if($_POST['upload_file'] == "Upload"){
      ...
      $cek_jml_file = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM approval_file WHERE approval_sublist_id = '$id_list'"));
  ...
  if(isset($_POST['submit_add_list'])){
    if($_POST['submit_add_list'] == "Simpan"){
      ...
      if($add_list_approval){
        $_SESSION['alert_success'] = "Terimakasih! Approval project berhasil ditambahkan";
      }else{
        $_SESSION['alert_error'] = "Gagal! Approval project gagal ditambahkan";
      }
    }
  }
...
<div class="wrapper">
  ...
  <?php
    ...
    }elseif($_GET["pages"]=="listapproval2"){
      require_once "listapproval-old.php";
