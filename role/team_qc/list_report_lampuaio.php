<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List Report QC Lampu All In One</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Lampu All In One</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                <div class="float-right">
                  <a href="#modal" data-toggle='modal' data-target='#show_add_report_lampuaio' data-id='<?php echo $get_Project['id']; ?>' data-toggle="tooltip" data-placement="bottom" title="Tambah Report Lampu All In One Baru">
                    <span class="fa fa-plus"></span> Tambah Report Lampu All In One Baru
                  </a>
                </div>
              </div>
              <!-- ./card-header -->
              <div class="card-body">
                <table id="show_search_and_pagging2" class="table table-bordered table-striped table-sm" style="font-size: 12px;">
                  ...
                  <tbody>
                    <?php
                      $no = 0;
                      $q_getListReportQC = mysqli_query($conn, "SELECT * FROM qc_reportlist WHERE form = 'lampu_aio'");
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="index.php?pages=formreportlampuaio&id=<?php echo $getListReportQC['id']; ?>">
  ...
  <!-- Modal start here -->
  <div class="modal fade" id="show_add_report_lampuaio" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Tambah Report Lampu All In One Baru</h4>
