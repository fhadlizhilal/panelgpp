...
?>
  ...
  <div class="card">
    <div class="card-body">
      <center><div style="font-size: 20px; font-weight: bold;">Laporan Quality Control</div></center>
      <br>
      <table width="100%">
        <tbody>
          <tr>
  ...
  <?php if($getListReportQC['form'] == "PV Module"){ ?>
    <div class="card">
      <div class="card-body">
        <table id="example6" class="table table-bordered table-striped table-sm" style="font-size: 11px;">
          <thead>
            <tr align="center">
              <th width="2%">No</th>
              ...
              <th width="14%">Foto</th>
              <th width="">Random Check</th>
              <th width="">Ket Random Check</th>
          ...
          <tbody>
            <?php
              $no = 0;
              $q_getDetailListPV = mysqli_query($conn, "SELECT * FROM list_report_pv");
            ...
            ?>
              <tr>
                ...
                <td><?php echo $getDetailListPV['random_check'] ?></td>
