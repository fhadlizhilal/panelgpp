                ...
                <div class="card-body">
                  <table class="table">
                    ...
                    <tr>
                      <td>Nama Sub List</td>
                      <th width="1%">:</th>
                      <td><?php echo $get_sub_approval_list['nama_sub']; ?></td>
                    </tr>
                  </table>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <div style="color: red;">Yakin delete sub list approval ini?</div>
                  <input type="hidden" name="id" value="<?php echo $id; ?>">
                  <input type="submit" class="btn btn-danger float-right" name="delete_sub_listapproval" value="Delete">
                </div>
                <!-- /.card-footer -->
              </form>
              <!-- /.card-body -->
