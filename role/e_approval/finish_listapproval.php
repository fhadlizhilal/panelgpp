  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Finish List Approval</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Finish List Approval</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <form class="form-horizontal" method="post" action="../<?php echo $_SESSION['role']; ?>/index.php?pages=listapproval&tahun=<?php echo $_SESSION['tahun']; ?>" enctype="multipart/form-data" style="font-size: 12px;">
                ...
                <div class="card-footer">
                  <div style="color: red;">Yakin finish list approval ini?</div>
                  <input type="hidden" name="id" value="<?php echo $id; ?>">
                  <input type="submit" class="btn btn-success float-right" name="finish_listapproval" value="Finish">
                </div>
                <!-- /.card-footer -->
              </form>
              <!-- /.card-body -->
