      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12 col-12">
            ...
            <div class="small-box">
              <br>
              <form method="GET" action="index.php?pages=myteamdailyreport">
                <div class="inner">
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4 col-xs-4 col-4">
                      <div class="form-group">
                        <center><label for="Bulan">Karyawan</label></center>
                        <select class="form-control" name="karyawan" style="font-size: 12px">
                          <option value="" <?php if(!isset($_GET['karyawan'])){ echo "selected" ; } ?> disabled >--- Pilih Karyawan ---</option>
                          <option value="12150402100798" <?php if($_GET['karyawan'] == "12150402100798"){ echo "selected" ; } ?> >Maldiyanti Nispi Kurnia</option>
                          <option value="12150403220402" <?php if($_GET['karyawan'] == "12150403220402"){ echo "selected" ; } ?> >Fitria Dwi Anggraeni</option>
                          <option value="12150501220698" <?php if($_GET['karyawan'] == "12150501220698"){ echo "selected" ; } ?> >Tami Putria</option>
                          <option value="12150512240902" <?php if($_GET['karyawan'] == "12150512240902"){ echo "selected" ; } ?> >Siska Anggi Prasetia</option>
                          <option value="12150511020997" <?php if($_GET['karyawan'] == "12150511020997"){ echo "selected" ; } ?> >Andri Septiyana</option>
                          <option value="12150503030801" <?php if($_GET['karyawan'] == "12150503030801"){ echo "selected" ; } ?> >Yoga Gustaman</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12">
                      <center>
                        <input type="hidden" name="pages" value="myteamdailyreport">
