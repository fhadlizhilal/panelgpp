            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example3" class="table table-bordered table-striped" style="font-size: 10px;">
                  ...
                  <tbody>
                    <?php
                      $q_listforecast = mysqli_query($conn, "SELECT * FROM forecast WHERE nik_sales = '$_SESSION[nik]' AND status_view = 'archive' ORDER BY tgl_dibuat DESC");
                    ...
                    ?>
                      <tr <?php if($threshold != "-" && $d_threshold < 1){ echo "style='background-color: #b3000a;'";} ?>>
                        ...
                        <td style="font-size: 14px;">
                           <a href="#modal" data-toggle='modal' data-target='#show_edit_forecast' data-id='<?php echo $get_forecast['kd_forecast']; ?>'>
                            <span class="fa fa-edit"></span> 
                          </a>
                            
                          <a href="#modal" data-toggle='modal' data-target='#show_update_activity' data-id='<?php echo $get_forecast['kd_forecast']; ?>'>
                            <span class="fa fa-upload"></span> 
                          </a>
                            
                          <a href="#modal" data-toggle='modal' data-target='#show_history_activity' data-id='<?php echo $get_forecast['kd_forecast']; ?>'>
