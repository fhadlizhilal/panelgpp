...
<!-- Content Wrapper. Contains page content -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title float-sm-right" style="font-size: 12px;">
                  <a href="index.php?pages=add-peminjaman"><span class="fa fa-plus"></span> Peminjaman Baru</a>
                </h3>
              </div>
              <!-- ///.card-header -->
              <div class="card-body">
                <table id="example3" class="table table-bordered table-striped table-sm" style="font-size: 10px;">
                  ...
                  <tbody>
                    <?php
                      $q_getPeminjaman = mysqli_query($conn, "SELECT * FROM tools_peminjaman WHERE nik = '$_SESSION[nik]' ORDER BY id DESC");
                    ...
                    ?>
                      <tr>
                        <td>
                          <a href="#modal" data-toggle='modal' data-target='#show_tools_pinjam' data-id='<?php echo $get_peminjaman['no_pinjam']; ?>' data-toggle="tooltip" data-placement="bottom" title="Lihat Detail Pinjam"><?php echo $get_peminjaman['no_pinjam']; ?></a>
                        </td>
                        ...
                        <td style="font-size: 14px;">
                          <?php if($get_peminjaman['status_pinjam'] == "Diajukan"){ ?>
                            <a href="#modal" data-toggle='modal' data-target='#show_edit_peminjaman_tools' data-id='<?php echo $get_peminjaman['no_pinjam']; ?>' data-toggle="tooltip" data-placement="bottom" title="Edit Peminjaman" ><span class="fa fa-edit"></span></a>

                            <a href="#modal" data-toggle='modal' data-target='#show_batalkan_peminjaman_tools' data-id='<?php echo $get_peminjaman['no_pinjam']; ?>' data-toggle="tooltip" data-placement="bottom" title="Batalkan Peminjaman" ><span class="fa fa-close"></span></a>
                          <?php }else{ ?>
  ...
  <!-- Modal start here -->
  <div class="modal fade" id="show_tools_pinjam" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Detail Tools Pinjam</h4>
