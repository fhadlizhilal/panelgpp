<?php
  ...
  if(!isset($_SESSION["role"]) || $_SESSION["role"] != "adm_marketing"){
  ...
  if(isset($_POST['newproject'])){
    if($_POST['newproject'] == "New Project"){
      ...
      $hpp_barang = preg_replace("/[^0-9]/","",$_POST['hpp_barang']);
      $hpp_jasa = preg_replace("/[^0-9]/","",$_POST['hpp_jasa']);
      $hpp_asset = preg_replace("/[^0-9]/","",$_POST['hpp_asset']);
      ...
      //Push To Project
      $reset_AI = mysqli_query($conn, "ALTER TABLE project AUTO_INCREMENT = 1");
      $push_toproject = mysqli_query($conn, "INSERT INTO project VALUES ('','$kd_project','','$nik','$badan','$nama_project','$notiket','$nosph','$nospk','$namacustomer','$nohp','$perusahaan','$kapasitas','$satuan_kapasitas','$jumlah_order','$satuan_order','$lokasi','$tipe_proyek','$start','$deadline','$nilai_proyek','$hpp_barang','$hpp_jasa','$hpp_asset','$ppn','$cashback','$remark','$this_day')");

      if($push_toproject){
        $_SESSION['alert_success'] = "Berhasil! Project baru berhasil dibuat";
      }else{
        $_SESSION['alert_error'] = "Gagal! Project baru gagal dibuat <br>".mysqli_error($conn);
      }
  ...
  if(isset($_POST['editproject'])){
    if($_POST['editproject'] == "Simpan Project"){
      //Push Edit
      $update_project = mysqli_query($conn, "UPDATE project SET kd_project = '$_POST[kode_project]', kd_forecast = '$_POST[kode_forecast]', nik_sales = '$_POST[nik_sales]', kd_badan = '$_POST[badan]', nm_project = '$_POST[nama_project]', no_ticket = '$_POST[notiket]', no_sph = '$_POST[nosph]', no_spk = '$_POST[nospk]', nm_customer = '$_POST[namacustomer]', nohp = '$_POST[nohp]', perusahaan = '$_POST[perusahaan]', kapasitas = '$_POST[kapasitas]', satuan_kapasitas = '$_POST[satuan_kapasitas]', jumlah_order = '$_POST[jumlah_order]', satuan = '$_POST[satuan_order]', lokasi_project = '$_POST[lokasi]', tipe_project = '$_POST[tipe_proyek]', start = '$_POST[start]', deadline = '$_POST[deadline]', nilai_project = '$_POST[nilai_proyek]', hpp_barang = '$_POST[hpp_barang]', hpp_jasa = '$_POST[hpp_jasa]', hpp_asset = '$_POST[hpp_asset]', ppn = '$_POST[ppn]', cashback = '$_POST[cashback]', remark = '$_POST[remark]' WHERE id = '$_POST[id]'");
  ...
  //Delete Project
  if(isset($_POST['hapusproject'])){
    if($_POST['hapusproject'] == "Delete"){
      $delete_project = mysqli_query($conn, "DELETE FROM project WHERE id = '$_POST[id]'");
...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($_GET['pages'] == 'newproject' || $_GET['pages'] == 'listproject' || $_GET['pages'] == 'petaproject'){ echo "menu-open"; }?>">
            <a href="#" class="nav-link <?php if($_GET['pages'] == 'newproject' || $_GET['pages'] == 'listproject' || $_GET['pages'] == 'petaproject'){ echo "active"; }?>">
              <i class="nav-icon fa fa-file-text-o"></i>
              <p>
                Project
                <i class="fas fa-angle-left right"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?pages=newproject" class="nav-link <?php if($_GET['pages'] == 'newproject'){ echo "active"; }?>">
                  <i class="fa fa-chevron-right nav-icon"></i>
                  <p>New Project</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?pages=listproject" class="nav-link <?php if($_GET['pages'] == 'listproject'){ echo "active"; }?>">
                  <i class="fa fa-chevron-right nav-icon"></i>
                  <p>List Project</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?pages=petaproject" class="nav-link <?php if($_GET['pages'] == 'petaproject'){ echo "active"; }?>">
                  <i class="fa fa-chevron-right nav-icon"></i>
                  <p>Peta Project</p>
                </a>
              </li>
  ...
  <?php
    ...
    }elseif($_GET["pages"]=="petaproject"){
      require_once "../unrole/petaproject/datapetaproject.php";
    }
  ?>
  <!-- ./Konten Wrapper -->
