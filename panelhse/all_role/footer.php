...
<script>
  $(function () {
    $("#showallnosearch").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false, "ordering": false, "searching" : false, "displayLength" : 100,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#example3_wrapper .col-md-6:eq(0)');
    $('#showallnosearch2').DataTable({
      "paging": false,
      "lengthChange": false,
      "searching": false,
      "ordering": true,
...
<!-- ----- Set Pimpro ------------------------ -->
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_delete_merek').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_report_text').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/report_text.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_add_list_induction').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/add_list_induction.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_edit_datapribadi').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../SPK/edit_datapribadi.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- EDIT STATUS LINK SPK ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_edit_status_linkspk').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/edit_status_spk.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- ADD TOOLS APD ONSITE ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_add_data_onsite').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/add_toolsapd_onsite.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- DELETE LIST INDUCTION ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_delete_list_induction').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/delete_list_induction.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_report_toolsapdonsite').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url : '../HSE/detail_toolsapd_onsite.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_report_inspeksiapd').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url : '../HSE/detail_inspeksi_apd.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- DELETE DOKUMENTASI INSPEKSI APD ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#delete_dokumentasi_inspeksiapd').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/delete_foto_inspeksi_apd.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- EDIT DATA INSPEKSI APAR ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_edit_data_apar').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/edit_data_inspeksi_apar.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- DELETE DATA INSPEKSI APAR ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_delete_data_apar').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/delete_data_inspeksi_apar.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
...
<!-- ----- EDIT DATA INSPEKSI P3K ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_edit_data_p3k').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/edit_data_inspeksi_p3k.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- DELETE DATA INSPEKSI P3K ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_delete_data_p3k').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/delete_data_inspeksi_p3k.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
  ...
  <!-- ----- ADD DOKUMENTASI INSPEKSI P3K ------------------------ -->
  <script type="text/javascript">
    $(document).ready(function(){
        $('#show_add_dokumentasi_p3k').on('show.bs.modal', function (e) {
            var getID = $(e.relatedTarget).data('id');
            /* fungsi AJAX untuk melakukan fetch data */
            $.ajax({
                type : 'post',
                url : '../HSE/add_dokumentasi_inspeksi_p3k.php',
                /* detail per identifier ditampung pada berkas detail.php yang berada di folder application/view */
                data :  'getID='+ getID,
                /* memanggil fungsi getDetail dan mengirimkannya */
                success : function(data){
