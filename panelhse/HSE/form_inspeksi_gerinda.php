  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Form Inspeksi Gerinda AC</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="modal-body">
          <form id="myForm" method="POST" target="">
            ...
            <table class="table table-sm" style="font-size: 12px;">
              ...
              <tr>
                <td>3. Steker pada kabel gerinda dalam kondisi bagus</td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>5. Side handle tersedia dan dalam kondisi bagus</td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>6. Terdapat cover / proteksi batu berinda teresdia dan terpasang</td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>7. Carbon brush dalam kondisi bagus</td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>8. Ventilasi udara gerinda bersih</td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>9. Kondisi mesin atau motor dalam kondisi bagus</td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>10. Flange / penjepit batu gerinda terpasang dengan kuat </td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>11. Pastikan cakram / batu gerinda terpasang kuat dan dalam kondisi bagus</td>
                <td>:</td>
                <td>
              ...
              <tr>
                <td>12. Terdapat kunci untuk membuka dan mengencangkan flange cakram</td>
                <td>:</td>
                <td>
