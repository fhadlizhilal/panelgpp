...
<?php
  ...
  if(isset($_POST['add_dokumentasi_inspeksimesinlas_v2'])){
    if($_POST['add_dokumentasi_inspeksimesinlas_v2'] == "Upload"){
      $jml_uploaddokumentasi_berhasil = 0;
      $jml_uploaddokumentasi_gagal = 0;
      $nodate = date('YmdHis');
      $inspeksi_id = $_POST['inspeksi_id'];
      $target_dir = "../../role/HSE/foto_inspeksi_mesinlas/";
      ...
      for ($i = 0; $i < $total; $i++) {
        ...
        if ($tmpFilePath != "" && in_array($imageFileType, $allowed_types)) {
            if($compressedImage){
                $push_dokumentasi_inspeksigerinda = mysqli_query($conn, "INSERT INTO hse_inspeksilist_fotomesinlas VALUES('','$inspeksi_id','$filename','$keterangan[$i]')");
                    ...
                    <tr>
                      ...
                      <td align="center" colspan="3">
                        ...
                        <form id="myForm4" action="" method="post" enctype="multipart/form-data">
                          ...
                          <input type="submit" class="btn btn-secondary btn-xs" name="add_dokumentasi_inspeksimesinlas_v2" value="Upload"><br><br>
                        </form>
                      </td>
                    </tr>
                    <tr>
