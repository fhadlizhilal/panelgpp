...
<table class="table table-sm table-striped" width="100%" style="font-size: 10px; margin-top: 15px;">
	...
	<?php
		$no=1;
		$q_inductionreport_spk = mysqli_query($conn, "SELECT * FROM hse_inductionreport_spk WHERE induction_id = '$id'");
	...
	?>
		<tr>
			...
			<td style="font-size: 14px">
				<a href="../SPK/index.php?pages=reportspk&induction_spk_id=<?php echo $get_inductionreport_spk['id']; ?>&file_name=<?php echo "SPK_".$get_project['nama_project']."_".$get_inductionreport_spk['nama']; ?>" target="_blank"><span class="fa fa-file-text-o"></span></a>

				<a href="index.php?delete=data_spk&pages=listspk&id=<?php echo $get_inductionreport_spk['id']; ?>" onclick="return confirm('Yakin hapus data SPK ini : <?php echo $get_inductionreport_spk['nama']; ?>?')"><span class="fa fa-trash" style="color: red"></span></a>
			</td>
		</tr>
	<?php $no++; } ?>
</table>