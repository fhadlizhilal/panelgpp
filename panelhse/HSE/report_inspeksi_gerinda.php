                  ...
                  <div class="col-12">
                    ...
                    <table class="table table-bordered table-sm" style="font-size: 11px">
                      <tr>
                        ...
                        <td rowspan="3" style="vertical-align: middle;"><center><img src="../../dist/img/pict gerindaac.png" width="50%"></center></td>
                      </tr>
  ...
  <script>
    document.title = "<?php echo "Report Inspeksi Gerinda AC W".$week." - ".$get_project['nama_project']; ?>";
  </script>