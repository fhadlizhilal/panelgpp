  <?php
    ...
    $get_num_inspeksi_bordc = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM hse_inspeksilist_detailbordc WHERE inspeksi_id = '$_GET[kd]'"));

    // GET DATA BOR DC FROM DB
    $i = 0;
    $q_get_inspeksilist_detailbordc = mysqli_query($conn, "SELECT * FROM hse_inspeksilist_detailbordc WHERE inspeksi_id = '$_GET[kd]'");
    while($get_inspeksilist_detailbordc = mysqli_fetch_array($q_get_inspeksilist_detailbordc)){
      $merek_tipe[$i] = $get_inspeksilist_detailbordc["merek_tipe"];
      $point_1[$i] = $get_inspeksilist_detailbordc["point_1"];
      $point_2[$i] = $get_inspeksilist_detailbordc["point_2"];
      $point_3[$i] = $get_inspeksilist_detailbordc["point_3"];
      $point_4[$i] = $get_inspeksilist_detailbordc["point_4"];
      $point_5[$i] = $get_inspeksilist_detailbordc["point_5"];
      $point_6[$i] = $get_inspeksilist_detailbordc["point_6"];
      $point_7[$i] = $get_inspeksilist_detailbordc["point_7"];
      $point_8[$i] = $get_inspeksilist_detailbordc["point_8"];
      $point_9[$i] = $get_inspeksilist_detailbordc["point_9"];
      $point_10[$i] = $get_inspeksilist_detailbordc["point_10"];
      $point_11[$i] = $get_inspeksilist_detailbordc["point_11"];

      $i++;
    }

    // GET DOKUMENTASI BOR DC
    $x=0;
    ...
    while($get_dokumentasi_inspeksi_bordc = mysqli_fetch_array($q_get_dokumentasi_inspeksi_bordc)){
      $foto_bordc[$x] = $get_dokumentasi_inspeksi_bordc["foto"];
      $keterangan_bordc[$x] = $get_dokumentasi_inspeksi_bordc["keterangan"];
        ...
        <div class="row">
          <div class="col-lg-12 col-12">
            <div class="card" style="margin-right: -10px;">
              ...
              <?php if($get_num_inspeksi_bordc <= 3){ ?>
              <!--------------------------------- JUMLAH BOR DC <= 3 ---------------------------------------->
              <div class="card-body">
                  ...
                  <div class="col-12">
                    <table class="table table-bordered table-sm">
                      <tr>
                        ...
                        <td width="70%" style="font-size: 12px; font-weight: bold;"><center>CHECKLIST INSPEKSI BOR DC</center></td>
                  ...
                  <div class="col-12">
                    <table class="table table-bordered table-striped table-sm" style="font-size: 11px;">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>Tombol pengatur kecepatan berfungsi dengan baik</td>
                          <td align="center">
                        ...
                        <tr>
                          <td>3</td>
                          <td>Battery tersedia dan terdapat cadangan dalam kondisi baik</td>
                          <td align="center">
                        ...
                        <tr>
                          <td>5</td>
                          <td>Tombol mode tersedia dan berrfungsi dengan baik</td>
                          <td align="center">
                        ...
                        <tr>
                          <td>6</td>
                          <td>Rumah mata bor dapat mengunci dan dalam keadaan baik</td>
                          <td align="center">
                        ...
                        <tr>
                          <td>9</td>
                          <td>Charger battery tersedia dan dalam kondisi baik</td>
                          <td align="center">
                    ...
                    <table class="table table-bordered table-sm" style="font-size: 12px">
                      ...
                      <tr>
                        <td width="25%" align="center">
                          <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[0]; ?>" style="height: 150px;">
                          <div style="text-align: center;"><?php echo $keterangan_bordc[0]; ?></div>
                        </td>
                        <td width="25%" align="center">
                          <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[1]; ?>" style="height: 150px;">
                          <div style="text-align: center;"><?php echo $keterangan_bordc[1]; ?></div>
                        </td>
                        <td width="25%" align="center">
                          <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[2]; ?>" style="height: 150px;">
                          <div style="text-align: center;"><?php echo $keterangan_bordc[2]; ?></div>
                        </td>
                        <td width="25%" align="center">
                          <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[3]; ?>" style="height: 150px;">
                          <div style="text-align: center;"><?php echo $keterangan_bordc[3]; ?></div>
                        </td>
                      </tr>
                      <?php
                        if($foto_bordc[4] <> "" || $foto_bordc[5] <> "" || $foto_bordc[6] <> "" || $foto_bordc[7] <> ""){ 
                      ?>
                        <tr>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[4] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[4]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[4]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[5] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[5]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[5]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[6] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[6]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[6]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[7] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[7]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[7]; ?></div>
                            <?php } ?>
                          </td>
                        </tr>
                      <?php } ?>
                      <?php
                        if($foto_bordc[8] <> "" || $foto_bordc[9] <> "" || $foto_bordc[10] <> "" || $foto_bordc[11] <> ""){
                      ?>
                        <tr>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[8] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[8]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[8]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[9] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[9]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[9]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[10] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[10]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[10]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[11] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[11]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[11]; ?></div>
                            <?php } ?>
                          </td>
                        </tr>
                      <?php } ?>
                      <?php
                        if($foto_bordc[12] <> "" || $foto_bordc[13] <> "" || $foto_bordc[14] <> "" || $foto_bordc[15] <> ""){
                      ?>
                        <tr>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[12] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[12]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[12]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[13] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[13]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[13]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[14] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[14]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[14]; ?></div>
                            <?php } ?>
                          </td>
                          <td width="25%" align="center">
                            <?php if($foto_bordc[15] <> ""){ ?>
                              <img src="../../role/HSE/foto_inspeksi_bordc/<?php echo $foto_bordc[15]; ?>" style="height: 150px;">
                              <div style="text-align: center;"><?php echo $keterangan_bordc[15]; ?></div>
                            <?php } ?>
                          </td>
                        </tr>
                      <?php } ?>
                    ...
                    <table class="table table-bordered table-sm" style="font-size: 12px">
                      ...
                      <?php
                        $get_num_bordc_bagus = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM hse_inspeksilist_detailbordc WHERE inspeksi_id = '$_GET[kd]' AND hasil_akhir = 'Baik'"));
                        $get_num_bordc_sedang = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM hse_inspeksilist_detailbordc WHERE inspeksi_id = '$_GET[kd]' AND hasil_akhir = 'Rusak'"));
                        $get_num_bordc_buruk = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM hse_inspeksilist_detailbordc WHERE inspeksi_id = '$_GET[kd]' AND hasil_akhir = 'Hilang'"));
                        ...
                        for($i=1;$i<$week;$i++){
                          ...
                          $t_bordc_hilangrusak_minggu_lalu = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM hse_inspeksilist_detailbordc WHERE inspeksi_id = '$get_inspeksilist2[id]' AND (hasil_akhir = 'Rusak' OR hasil_akhir = 'Hilang')")) + $t_bordc_hilangrusak_minggu_lalu;
                        }
                      ?>
                      <tr>
                        <td align="center"><?php echo $get_num_bordc_bagus; ?></td>
                        <td align="center"><?php echo $get_num_bordc_sedang; ?></td>
                        <td align="center"><?php echo $get_num_bordc_buruk; ?></td>
              ...
              <?php }elseif($get_num_inspeksi_bordc <= 6){ ?>
              ...
              <?php }elseif($get_num_inspeksi_bordc <= 9){ ?>
                  ...
                  <div class="col-12">
                    ...
                    <table class="table table-bordered table-striped table-sm" style="font-size: 11px;">
                      <thead style="text-align: center;">
                        ...
                        <tr>
                          <th colspan="4"><?php echo $merek_tipe[6]; ?></th>
                          <th colspan="4"><?php echo $merek_tipe[7]; ?></th>
                          <th colspan="4"><?php echo $merek_tipe[8]; ?></th>
                        </tr>
                        <tr>
                          <th colspan="4">Kondisi</th>
                          <th colspan="4">Kondisi</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Tombol pengatur kecepatan berfungsi dengan baik</td>
                          <td align="center">
                            <?php if($point_1[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_1[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_1[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_1[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>2</td>
                          <td>Tombol switch pemutar kedalam dan keluar berfunsi dengan baik</td>
                          <td align="center">
                            <?php if($point_2[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_2[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_2[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_2[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>3</td>
                          <td>Battery tersedia dan terdapat cadangan dalam kondisi baik</td>
                          <td align="center">
                            <?php if($point_3[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_3[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_3[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_3[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>4</td>
                          <td>Mesin penggerak atau motor penggerak berfungsi baik</td>
                          <td align="center">
                            <?php if($point_4[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_4[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_4[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_4[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>5</td>
                          <td>Tombol mode tersedia dan berrfungsi dengan baik</td>
                          <td align="center">
                            <?php if($point_5[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_5[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_5[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_5[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>6</td>
                          <td>Rumah mata bor dapat mengunci dan dalam keadaan baik</td>
                          <td align="center">
                            <?php if($point_6[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_6[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_6[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_6[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>7</td>
                          <td>Vent angin mesin bor tidak tertutup</td>
                          <td align="center">
                            <?php if($point_7[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_7[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_7[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_7[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>8</td>
                          <td>Badan mesin bor dalam kondisi baik</td>
                          <td align="center">
                            <?php if($point_8[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_8[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_8[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_8[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                        <tr>
                          <td>9</td>
                          <td>Charger battery tersedia dan dalam kondisi baik</td>
                          <td align="center">
                            <?php if($point_9[6] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[6] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[6] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[6] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_9[7] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[7] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[7] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[7] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>

                          <td align="center">
                            <?php if($point_9[8] == "Baik"){ ?><span class="fa fa-check"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[8] == "Rusak"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[8] == "Hilang"){ ?><span class="fa fa-close"></span><?php } ?>
                          </td>
                          <td align="center">
                            <?php if($point_9[8] == "NA"){ ?><span class="fa fa-minus"></span><?php } ?>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table class="table table-bordered table-sm" style="font-size: 11px">
                      <tr>
                        ...
                        <td rowspan="3" style="vertical-align: middle;"><center><img src="../../dist/img/pict_bordc.jpg" width="100%"></center></td>
                      </tr>
                      <tr>
                        <td>
                            Catatan :<br>
